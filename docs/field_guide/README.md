...
- **Design Considerations**
  ...
  - [**Security, Compliance and Data Residency**](./Security_Compliance_DataResidency.md) — Secrets and key management, network security, compliance standards, data residency, and extended security updates.
